...
\hypersetup{
  pdftitle={morphableUI: A Framework...}, %%
  pdfauthor={Andrey Krekhov}, %%
  pdfsubject={Master's Thesis, Saarland University, March 2011}, %%
  pdfcreator={}, %%
  pdfproducer={}, %%
  pdfkeywords={distributed interaction, automatic UI generation, distributed systems} %%
}
