...
enum SOCKET_STATE {SOCKET_CONNECTED_IDLE, SOCKET_NOT_CONNECTED_IDLE, SOCKET_WAIT_FOR_MODEL_LIST_SIZE , SOCKET_WAIT_FOR_MODEL_LIST, SOCKET_WAIT_FOR_HELLO, SOCKET_WAIT_SERVER_LOAD_MODEL, SOCKET_WAIT_FOR_SPM_BASE_INFO_DATA_SIZE, SOCKET_WAIT_FOR_SPM_BASE_INFO_DATA, SOCKET_WAIT_FOR_SPM_VSPLIT_DATA_SIZE, SOCKET_WAIT_FOR_SPM_VSPLIT_DATA};
